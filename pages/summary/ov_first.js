...
function Menu({ navigation }) {
    return (
        <View style={styles.menu}>
            <Pressable onPress={() => navigation.navigate("FirstOverview")}><Text style={{ fontFamily: 'Poppins-Bold', fontSize: 16, color: Themes.colors.purple }}>Overview</Text></Pressable>
...
function SummaryOverview({ navigation }) {
    return (
        <SafeAreaView style={styles.screen}>
            ...
            <Box title={"most productive day"} times={["tuesday"]} stats={["3 work sessions", "2 tasks: Laundry, CS106A"]} />
            <Box title={"most focused periods"} times={["9-11am", "3-7pm"]} stats={["Able to achieve 65% of goals scheduled during these times"]} />
            <Insights insights={["Early bird - you started work early in the morning this week!"]} />
        </SafeAreaView>
    );
}
