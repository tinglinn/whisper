...
function Menu({ navigation }) {
    return (
        <View style={styles.menu}>
            ...
            <Pressable onPress={() => navigation.navigate("PrevAccomplishments")}><Text style={{ fontFamily: 'Poppins-Bold', fontSize: 16, color: Themes.colors.purple }}>Accomplishments</Text></Pressable>
...
const data = [
    { name: "Tasks completed", stat: "8", trend: "up" },
    { name: "Work sessions started", stat: "11", trend: "up" },
    { name: "Work session goals completed", stat: "10", trend: "up" },
    { name: "Average work session length", stat: "1.3h", trend: "down" }];
...
function Accomplishments({ navigation }) {
    return (
        <SafeAreaView style={styles.screen}>
            ...
            <Insights insights={["Watch out - you started 2 tasks less than 1 day before the deadline!"]} />
        </SafeAreaView>
    );
}
