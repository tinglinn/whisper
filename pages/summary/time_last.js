...
function Menu({ navigation }) {
    return (
        <View style={styles.menu}>
            <Pressable onPress={() => navigation.navigate("PrevOverview")}><Text style={styles.menuText}>Overview</Text></Pressable>
            <Pressable onPress={() => navigation.navigate("PrevAccomplishments")}><Text style={styles.menuText}>Accomplishments</Text></Pressable>
            <Pressable onPress={() => navigation.navigate("PrevTime")}><Text style={{ fontFamily: 'Poppins-Bold', fontSize: 16, color: Themes.colors.purple }}>Time</Text></Pressable>
        </View>
    );
}
...
const data = [
    { name: "Time Estimated for Tasks", stat: 13 },
    { name: "Time Needed for Tasks", stat: 14 }];
        ...
        <View style={styles.box}>
            ...
            <View style={styles.boxBody}>
                <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 18, color: Themes.colors.darkgray }}>13 hrs</Text>
                </View>
                ...
                <View style={{ marginBottom: 20 }}>
                    ...
                    <View style={{ marginTop: 8, paddingLeft: 20 }}>
                        <Text style={styles.stat}>• CS47 Project</Text>
                        <Text style={styles.stat}>• PHIL Essay</Text>
                        <Text style={styles.stat}>• Make schedule</Text>
                    </View>
                </View>
                <View>
                    <Text style={styles.stat}>you overestimated the time needed for:</Text>
                    <View style={{ marginTop: 8, paddingLeft: 20 }}>
                        <Text style={styles.stat}>• Laundry</Text>
                        <Text style={styles.stat}>• Clean up room</Text>
                    </View>
                </View>
            </View>
        </View>
